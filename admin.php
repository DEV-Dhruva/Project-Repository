...
<body>
    ...
    <div id="mainsection">
        <div class="main">
           <h4>Please Check the Uploaded files by 
			USERS are valid or not ?</h4>
            <hr>
            <table id="dtable" width="100%">
				    ...
				    while($rs=mysqli_fetch_array($result)){
					 ...
					 <tr>
                         ...
                         <td align='center'><a href='delete_ad.php?name=$fname&usname=$uname' class='btn btn-danger' onclick='confirm('sure?');'><i class='icon-trash icon-white'></a></td>
